...
--
-- Name: properties fx_properties_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fx_properties_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties fx_properties_types; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fx_properties_types FOREIGN KEY (type_id) REFERENCES public.types(type_id);
